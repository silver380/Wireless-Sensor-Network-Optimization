...
if __name__ == "__main__":
   ...
   print(f"popluatiobs average: {pop_avg}")

   max_BW = util.calculate_max_BW(map_size, pop_sum,user_satisfaction_levels[-1])
   min_BW= util.calculate_min_BW(map_size, user_satisfaction_levels[-1], blocks_population)

   print(f"map size: {map_size}, MAX bandwidth: {max_BW}, MIN bandwidth: {min_BW}, population size: {pop_sum}")
